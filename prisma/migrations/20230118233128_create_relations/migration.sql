/*
  ...
  - You are about to drop the `habitt_week` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropIndex
DROP INDEX "habitt_week_habbit_id_week_day_key";

-- DropTable
PRAGMA foreign_keys=off;
DROP TABLE "habitt_week";
PRAGMA foreign_keys=on;

-- CreateTable
CREATE TABLE "habit_week" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "habit_id" TEXT NOT NULL,
    "week_day" INTEGER NOT NULL,
    CONSTRAINT "habit_week_habit_id_fkey" FOREIGN KEY ("habit_id") REFERENCES "habits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "habit_week_habit_id_week_day_key" ON "habit_week"("habit_id", "week_day");
